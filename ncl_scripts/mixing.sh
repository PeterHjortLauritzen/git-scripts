...
#
ncl 'fname="'$file'"' 'vname="'$vname'"' 'nstep='$nstep 'dcore="'$dcore'"' $ncl_dir/mixing.ncl
...
#echo "set xtics ("'"0.0"'" 0.0,"'" "'"0.1,"'"0.2"'" 0.2,"'" "'" 0.3,"'"0.4"'" 0.4,"'" "'" 0.5,"'"0.6"'" 0.6,"'" "'" 0.7,"'"0.8"'" 0.8,"'" "'" 0.9,"'"1.0"'" 1.0)" >> filam#ent.gp 
