...
set caze=checkPS_${src}_${cset}_CAM_${res}_${pecount}_NTHRDS${NTHRDS}_${steps}${stopoption}
...
$homedir/$USER/src/$src/cime/scripts/create_newcase --case $scratch/$USER/$caze --compset $cset --res $res  --q $queue --walltime 12:00:00 --pecount $pecount  --project $PBS_ACCOUNT --compiler $compiler  --run-unsupported
