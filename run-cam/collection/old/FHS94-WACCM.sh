...
./xmlchange --append CAM_CONFIG_OPTS="-nlev 70" #there are already 6 tracers in FKESSLER
...
echo "ncdata = '/glade/u/home/cjablono/CESM_vertical_grids/cam_vcoords_L70_140kmTop_WACCM6.nc'" >> user_nl_cam
