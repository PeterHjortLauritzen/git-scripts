...
set caze=test_analytic_ic_FW2000climo #${src}_${cset}_${res}_${pecount}_NTHRDS${NTHRDS}_${steps}${stopoption}
...
./xmlchange --append CAM_CONFIG_OPTS=" -analytic_ic -nlev 70"
#./xmlchange CAM_CONFIG_OPTS=" -analytic_ic -cppdefs -Dwaccm_debug -nlev 70"
#
echo "CAM_CONFIG_OPTS:" 
...
#if ($nlev == "110") then
##  echo "ncdata = '/glade/p/cgd/amp/pel/inic/opt-se-cslam-IC_file_110L.nc'" >> user_nl_cam
...
#echo "se_nu = 0.25E15" >> user_nl_cam
...
echo "         'QVTENDICE', 'QCTENDICE', 'NCTENDICE', 'FQTENDICE', 'MASS','PMID','PDELDRY','E90','PTTEND','FT','OMEGAT','CLDTOT','TMQ','ABS_dPSdt','FU','FV','U','V','T','OMEGA500','OMEGA850','PSL','PS','VTGWORO', 'UTGWSPEC', 'VTGWSPEC', 'BUTGWSPEC','UTGWORO'">> user_nl_cam
echo "          "  >> user_nl_cam
