...
#./xmlchange CAM_CONFIG_OPTS="-phys cam6 -age_of_air_trcs -chem waccm_sc_mam4 -cppdefs -Dwaccm_debug"
#
...
#x#echo "se_nu_div = 2.5E15" >> user_nl_cam
...
echo "         'QVTENDICE', 'QCTENDICE', 'NCTENDICE', 'FQTENDICE', 'MASS','PMID','PDELDRY','PTTEND','FT','OMEGAT','CLDTOT','TMQ','ABS_dPSdt','FU','FV','U','V','T','OMEGA500','OMEGA850','PSL','PS','VTGWORO', 'UTGWSPEC', 'VTGWSPEC', 'BUTGWSPEC','UTGWORO'">> user_nl_cam   #,'E90'
echo "          "  >> user_nl_cam
