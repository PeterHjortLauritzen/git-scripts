...
echo "'ISOP     -> /glade/p/cesmdata/cseg/inputdata/atm/cam/chem/emis/CMIP6_emissions_1750_2015v2/emissions-cmip6_ISOP_bb_surface_1750-2015_0.9x1.25_c20170322.nc',">>user_nl_cam
echo "'MEK      -> /glade/p/cesmdata/cseg/inputdata/atm/cam/chem/emis/CMIP6_emissions_1750_2015v2/emissions-cmip6_MEK_anthro_surface_1750-2015_0.9x1.25_c20170608.nc',">>user_nl_cam
...
# CLM changes
#
echo "cli_scale=0.033d00">>user_nl_clm
echo "bt_min = 0.85d00">>user_nl_clm
echo "bt_max = 0.98d00">>user_nl_clm
echo "ufuel = 1050.d00">>user_nl_clm
echo "paramfile = '/glade/p/work/dlawren/cesm_code/paramfiles/clm5_params.c170329.fsrpft.nc'">>user_nl_clm
echo "irrig_threshold_fraction = 1.0">>user_nl_clm
echo "flanduse_timeseries = '/glade/p/cesmdata/cseg/inputdata/lnd/clm2/surfdata_map/landuse.timeseries_ne30np4_hist_78pfts_CMIP6_simyr1850-2015_c170824.nc'">>user_nl_clm
echo "fsurdat = '/glade/p/cesmdata/cseg/inputdata/lnd/clm2/surfdata_map/surfdata_ne30np4_78pfts_CMIP6_simyr2000_c170824.nc'">>user_nl_clm
echo "finidat = '/glade/p/acd/tilmes/inputdata/init/clm/f.e20.FW2010.f09_f09.mics11_cam5_4_117.001.clm2.r.0003-01-01-00000.nc'">>user_nl_clm
